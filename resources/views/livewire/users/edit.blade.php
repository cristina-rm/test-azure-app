				...
				<div class="bg-white p-6 sm:py-8 sm:px-16">
                    <div class="flex justify-between space-x-6">
                        <div class="w-full mb-6">
                            <x-jet-label for="first_name" value="{{ __('First Name') }}"></x-jet-label>
                    ...
                    {{--<div class="flex justify-between space-x-6">
                        <div class="w-full mb-6">
                            <x-jet-label for="password" value="{{ __('Password') }}"><span class="text-sm text-gray-500 font-normal">* (8 characters minimum)</span></x-jet-label>
                            <x-jet-input id="password" type="password" class="mt-1 block w-full" wire:model.defer="password" />
                            <x-jet-input-error for="password" class="mt-2" />
                        </div>

                        <div class="w-full mb-6">
                            <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}"><span class="text-sm text-gray-500 font-normal">*</span></x-jet-label>
